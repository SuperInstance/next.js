...
export interface NextConfig {
  ...
  /**
   * When enabled, a single route can combine a prerendered shell with dynamic
   * content streamed into it, rather than being either fully static or fully
   * dynamic. You can mark data and parts of your UI as cacheable using the
